...
class RestauranteController {
    ...
    private DistanciaRestClient restClient;
    ...
    public RestauranteDto atualiza(@RequestBody RestauranteDto restaurante) {
        ...
        if (!tipoDeCozinhaOriginal.getId().equals(restaurante.getTipoDeCozinha().getId()) || !cepOriginal.equals(restaurante.getCep())) {
            restClient.restauranteAtualizado(salvo);
        }
    ...
    public void aprova(@PathVariable("id") Long id) {
        ...
        restClient.novoRestauranteAprovado(restaurante);
    }
}
